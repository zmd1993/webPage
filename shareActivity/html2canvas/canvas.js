function canvasToImage(obj){
	...
	span+='<img class="ser-price-lable" src="html2canvas/price.png" /><div class="text-after">￥'+parameter.price+'</div></div>';
	...
	span+='<div id="mask" class="poster-mask hidden" onclick="closeShareImage()">图片生成中，请稍候…</div>';
	$('body').append(span)
}
